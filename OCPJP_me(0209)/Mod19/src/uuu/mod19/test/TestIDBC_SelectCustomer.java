 ...
 */
public class TestIDBC_SelectCustomer {
            ...
            try (//2.建立Connection
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        Logger.getLogger(TestIDBC_SelectCustomer.class.getName()).log(Level.SEVERE, "customer 資料不正確", ex);
                    }
                ...
                Logger.getLogger(TestIDBC_SelectCustomer.class.getName()).log(Level.SEVERE, "無法連線", ex);
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(TestIDBC_SelectCustomer.class.getName()).log(Level.SEVERE, "load JDB Driver failed:" + driver, ex);
        }
    }
}
