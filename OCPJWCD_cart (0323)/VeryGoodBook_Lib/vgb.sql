...
INSERT INTO products (id,name,unit_price,stock,description,photo_url,type,discount) VALUES 
 (1,'Microsoft® SQL Server® 2016管理實戰',699,10,'完整涵蓋SQL Server 2016及其向下相容版本之管理技巧。從DBA觀點出發，建立正確的資料庫系統觀念。最實用的企業級資料庫管理與維護指南，解決常見的技術瓶頸。','http://im2.book.com.tw/image/getImage?i=http://www.books.com.tw/img/001/074/14/0010741473.jpg&v=58760962&w=348&h=348','Book',21),
 (2,'笑談軟體工程-例外處理設計的逆襲',580,10,'這世界上，大部分軟體開發「大師」都只教你如何設計「軟體的光明面」, 卻很少人願意告訴你如何解決「軟體的黑暗面」。但很遺憾的，軟體的異常狀態（黑暗面）不會比正常狀態（光明面）少，是你該把「例外處理」當成一回事兒的時候了。','http://im2.book.com.tw/image/getImage?i=http://www.books.com.tw/img/001/063/75/0010637503.jpg&v=537dd241&w=348&h=348','Book',10),
