...
public class TestWrapperClass {
    public static void main(String[] args) {
        ...
        short s2 = (short)(theS1.shortValue());
        int i2 = theI1.intValue();
        double d2 =theD1.doubleValue();
        boolean t2 = theT1.booleanValue();
        
        //以下為autoboxing, 適用JDK 5以上ㄉ版本
        Byte theB2 = b1;
        Short theS2 = s1;
        Integer theI2 = i1;
        Double theD2 = d1;
        Boolean theT2 =t1;
        Character theC1 = '1';//Character the C1 = new Character('1');
        
        //以下為auto-unboxing, 適用JDK 5以上ㄉ版本
        Double d3 = theB2+ theD2+theC1;
        //Double d3 = new Double(theB2.byteValue()+ theD2.doubleValue()+theC1.char)
