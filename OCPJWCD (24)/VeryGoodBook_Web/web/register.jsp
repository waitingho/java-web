    ...
    <body>
        ...
        <div class="article">          
            ...
            <form action='register.do' method="POST">
                <p>
                    <label>帳號:</label>
                    <input accesskey="1" type='text' name='id' placeholder="請輸入身分證號" required pattern='[A-Z][12]\d{8}'
                ...
                <p>
                    <label>密碼:</label>
                    <input type='password' name='pwd1' placeholder="請輸入密碼" minlength="6" maxlength="20" required
                           value='${param.pwd1}'><br>
                    <label>確認:</label>
                    <input type='password' name='pwd2' placeholder="請輸入確認密碼" minlength="6" maxlength="20" required
                           value='${param.pwd2}'>
                </p>
                <p>
                    <label>性別:</label>       
