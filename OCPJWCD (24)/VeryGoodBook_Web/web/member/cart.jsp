            ...
            <form method="POST" action="update_cart.do">
                <table border='1' cellspacing='1' cellpadding='3' style='width:75%;margin: auto'>  
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <img src="<%= item.getProduct().getPhotoUrl() %>" style="width:75px;vertical-align: middle">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td colspan="1"><input type='submit' name="submit" value="修改購物車"></td>
                            <td colspan="2"><input type='submit' name="submit" value="我要結帳"></td>
                        </tr>                                    
                    </tfoot>
                </table>                
            </form>
